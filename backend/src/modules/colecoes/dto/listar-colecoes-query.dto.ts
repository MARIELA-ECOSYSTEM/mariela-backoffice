...
const ORDENAR_POR_VALORES: OrdenarColecaoPor[] = ["nome", "criadoEm", "inicio", "fim"];
...
/**
 * Espelha exatamente os grupos de filtro que a tela de Coleções já expõe
 * (`src/routes/_backoffice/colecoes/index.tsx`): situação (derivada de
 * período+ativo), destaque, banner e presença de produtos vinculados.
 */
export class ListarColecoesQueryDto {
  ...
  ordenarPor: OrdenarColecaoPor = "nome";
